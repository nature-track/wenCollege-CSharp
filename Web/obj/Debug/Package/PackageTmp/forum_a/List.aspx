<%@ Page Title="forum_a" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.forum_a.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="que_id" HeaderText="que_id" SortExpression="que_id" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="name" HeaderText="name" SortExpression="name" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="team" HeaderText="team" SortExpression="team" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="answer" HeaderText="answer" SortExpression="answer" ItemStyle-HorizontalAlign="Center"  /> 
