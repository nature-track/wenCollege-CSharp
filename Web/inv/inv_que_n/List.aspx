<%@ Page Title="inv_que_n" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.inv_que_n.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="subtitle" HeaderText="subtitle" SortExpression="subtitle" ItemStyle-HorizontalAlign="Center"  /> 
