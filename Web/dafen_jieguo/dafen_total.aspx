<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dafen_total.aspx.cs" Inherits="Maticsoft.Web.dafen_jieguo.dafen_total" %>
...
<body>
  ...
  <center>
      <div class="text1">
        ...
        <asp:GridView ID="View_yiyuan" runat="server" AutoGenerateColumns="False"       Width="100%" AlternatingRowStyle-BackColor="#e6e5e3">
                ...
                <asp:TemplateField >
                    <ItemTemplate>
                        ...
                        <fieldset class="big" >
                            ...
                            <asp:RadioButtonList ID="RadioButtonList2" runat="server" type="radio"  RepeatDirection="Horizontal"  Width="100%" CssClass="c1" RepeatLayout="Flow">
                                            <asp:ListItem Selected="True">愿意</asp:ListItem>
                                            <asp:ListItem >看情况</asp:ListItem>
                                            <asp:ListItem>不愿意</asp:ListItem>
                            </asp:RadioButtonList>
