...
namespace Maticsoft.DAL
{
	...
	public partial class dafenbiao
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "dafenbiao"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from dafenbiao");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from dafenbiao ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,leibie,text ");
			strSql.Append(" FROM dafenbiao ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from dafenbiao T ");
