...
namespace Maticsoft.DAL
{
	...
	public partial class fenzu
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "fenzu"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from fenzu");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from fenzu ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,qishu,zushu,zuming ");
			strSql.Append(" FROM fenzu ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,qishu,zushu,zuming ");
			strSql.Append(" FROM fenzu ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from fenzu T ");
